void NonePerFineLowDCA()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Jun 19 09:35:12 2020) by ROOT version 6.12/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(75,1079.25,225,1233.75);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1001 = new TH1F("Graph_Graph1001","",100,90,210);
   Graph_Graph1001->SetMinimum(1094.7);
   Graph_Graph1001->SetMaximum(1218.3);
