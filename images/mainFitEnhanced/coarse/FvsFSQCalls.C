...
//=========  (Mon Aug  3 17:43:18 2020) by ROOT version 6.12/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   gStyle->SetOptFit(1);
   c->SetHighLightColor(2);
   c->Range(-0.103077,-11.25,0.927693,224.25);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0,
   0};
   TGraphErrors *gre = new TGraphErrors(10,Graph0_fx1007,Graph0_fy1007,Graph0_fex1007,Graph0_fey1007);
   gre->SetName("Graph0");
   gre->SetTitle(";(t_{m+f} #minus t_{m})/t_{f} / event;Times FSQ is called / event");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1007 = new TH1F("Graph_Graph1007","",100,0,0.824616);
   Graph_Graph1007->SetMinimum(12.3);
   Graph_Graph1007->SetMaximum(200.7);
   ...
   TF1 *lineFit11008 = new TF1("lineFit1","pol1",0,0.824616, TF1::EAddToList::kNo);
   lineFit11008->SetFillColor(19);
   lineFit11008->SetFillStyle(0);
   lineFit11008->SetLineWidth(3);
   lineFit11008->SetChisquare(27.58576);
   lineFit11008->SetNDF(8);
   ...
   lineFit11008->SetParameter(0,20.08495);
   lineFit11008->SetParError(0,0.6875318);
   lineFit11008->SetParLimits(0,0,0);
   lineFit11008->SetParameter(1,218.5378);
   lineFit11008->SetParError(1,2.799535);
   ...
   TText *ptstats_LaTex = ptstats->AddText("#chi^{2} / ndf = 27.59 / 8");
   ptstats_LaTex = ptstats->AddText("p0       = 20.08 #pm 0.6875 ");
   ptstats_LaTex = ptstats->AddText("p1       = 218.5 #pm   2.8 ");
   ...
   gre->Draw("ap");
   TLine *line = new TLine(0.6340932,12.3,0.6340932,200.7);
   line->SetLineStyle(2);
   line->SetLineWidth(3);
   line->Draw();
   c->Modified();
