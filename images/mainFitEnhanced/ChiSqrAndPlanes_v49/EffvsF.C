...
//=========  (Mon Aug 10 15:15:04 2020) by ROOT version 6.12/04
   ...
   c->Range(-0.04381749,0.9971349,0.1064826,1.014325);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1001 = new TH1F("Graph_Graph1001","",100,-0.02878749,0.09145255);
   Graph_Graph1001->SetMinimum(0.998854);
   Graph_Graph1001->SetMaximum(1.012606);
   ...
   gre->Draw("ap");
   TLine *line = new TLine(0.04150801,0.998854,0.04150801,1.012606);
   line->SetLineColor(2);
   line->SetLineStyle(2);
   line->SetLineWidth(3);
   line->Draw();
