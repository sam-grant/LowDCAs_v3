...
for i in range(len(fnames)): # quality on/off files
	...
	for j in range(len(orientation)): 
		...
		DrawScat(tgr12, title, "../images/extrap/S12_"+orientation[j]+"Means") # DrawScat(graph, title, fname)
		DrawScat(tgr18, title, "../images/extrap/S18_"+orientation[j]+"Means") # DrawScat(graph, title, fname)