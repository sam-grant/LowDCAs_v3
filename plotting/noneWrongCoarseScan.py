...
# thresholds = [ "0.100", "0.105", "0.110", "0.115", "0.120",
# 	    "0.125", "0.135", "0.140", "0.145", "0.150", "0.155",
# 	    "0.160", "0.165", "0.170", "0.175", "0.180", "0.185",
# 	    "0.190", "0.195", "0.200" ] 

# thresholds = [ "0.100","0.120","0.140","0.160","0.180","0.200" ] 
# thresholds = [ "0.100","0.125","0.150","0.175","0.200","0.225", "0.250", "0.275", "0.300" ] 
# thresholds = [ "0.100","0.150","0.200","0.250", "0.300" ] 
...
for i_thres in range(len(thresholds)):
	...
	xaxis.append(float(thresholds[i_thres])*1e3)

	
	file = TFile.Open("../runNominalSimScan/noneWrong/simPlots_coarse.root")
	...
	entries.append(h1.GetEntries())



tgr = DefineScat(xaxis, entries)
...
DrawScat(tgr,";Low DCA threshold [#mum];Tracks with no wrong hits","../images/NonePerCoarseLowDCA")
